...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_GITNAME = BENSON.getGitName().toString();
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ID, VALID_GITNAME, VALID_HANDLE, VALID_ADDRESS, VALID_TAGS, VALID_ATTENDANCES);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ID, VALID_GITNAME, VALID_HANDLE, INVALID_ADDRESS, VALID_TAGS, VALID_ATTENDANCES);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, null,
                VALID_ID, VALID_GITNAME, VALID_HANDLE, VALID_TAGS, VALID_ATTENDANCES);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ID, VALID_GITNAME, VALID_HANDLE, VALID_ADDRESS, invalidTags, VALID_ATTENDANCES);
    ...
    public void toModelType_invalidAttendances_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ID, VALID_GITNAME, VALID_HANDLE, VALID_ADDRESS, VALID_TAGS, invalidAttendances);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
}

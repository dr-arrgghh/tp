...
public class EditPersonDescriptorBuilder {
    ...
    /**
     * Sets the {@code GitName} of the {@code EditPersonDescriptor} that we are building
     */
    public EditPersonDescriptorBuilder withGit(String gitName) {
        descriptor.setGitName(new GitName(gitName));
        return this;
    }
    ...
    public EditPersonDescriptorBuilder withHandle(String handle) {
        descriptor.setHandle(new TeleHandle(handle));
        return this;
    }

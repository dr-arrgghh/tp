...
import static seedu.studmap.testutil.TypicalPersons.AMY;
import static seedu.studmap.testutil.TypicalPersons.BOB;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ID_DESC_BOB + GIT_DESC_BOB + HANDLE_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_FRIEND, new AddCommand(expectedPerson));
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ID_DESC_BOB
                + GIT_DESC_BOB + HANDLE_DESC_BOB + ADDRESS_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ID_DESC_BOB + GIT_DESC_BOB + HANDLE_DESC_BOB + INVALID_ADDRESS_DESC
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                        + ID_DESC_BOB + GIT_DESC_BOB + HANDLE_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,

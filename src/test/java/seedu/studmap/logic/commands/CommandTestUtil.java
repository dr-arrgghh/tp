...
import seedu.studmap.testutil.EditPersonDescriptorBuilder;
...
public class CommandTestUtil {
    ...
    public static final String VALID_ID_AMY = "A1234567J";
    public static final String VALID_ID_BOB = "A1234567K";
    ...
    public static final String INVALID_ID_DESC = " " + PREFIX_ID; // should not be empty
    public static final String INVALID_GIT_DESC = " " + PREFIX_GIT; // should not be empty
    public static final String INVALID_HANDLE_DESC = " " + PREFIX_HANDLE; // should not be empty
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withID(VALID_ID_AMY).withGit(VALID_GIT_AMY)
                .withHandle(VALID_HANDLE_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
                .withID(VALID_ID_BOB).withGit(VALID_GIT_BOB)
                .withHandle(VALID_HANDLE_BOB).withAddress(VALID_ADDRESS_BOB)
